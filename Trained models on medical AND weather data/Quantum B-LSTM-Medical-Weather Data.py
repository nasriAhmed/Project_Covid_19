...
#************* Construction du modèle BLTSM *********
#Model BLTSM
from tensorflow.keras.layers import Bidirectional
from tensorflow.keras.layers import LSTM

clayer1 = tf.keras.layers.Bidirectional(LSTM(10, return_sequences=True),input_shape=(train_x.shape[1],1))
clayer3 = tf.keras.layers.Bidirectional(LSTM(10))
qlayer = qml.qnn.KerasLayer(qnode, weight_shapes, output_dim=2)
clayer6 = tf.keras.layers.Dense(1)
hybrid_model = tf.keras.models.Sequential([clayer1,clayer3,qlayer,clayer6])

opt = tf.keras.optimizers.SGD(learning_rate=0.5)
dot_img_file = '../Dataset/model_Blstm_quantum_medical_weather.png'
