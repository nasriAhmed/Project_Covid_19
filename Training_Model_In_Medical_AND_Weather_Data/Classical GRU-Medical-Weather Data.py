...
model = Sequential()
model.add(GRU(units = 40 , return_sequences=True , input_shape = (train_x.shape[1],1)))
model.add(GRU(units = 40 , return_sequences = True))
model.add(Dropout(0.2))
model.add(GRU(units= 40 , return_sequences = False))
model.add(Dense(25))
model.add(Dense(1))
#print(keras.utils.plot_model(model = model , to_file = 'AxisBankLSTM.png'))
dot_img_file = '../Dataset/model_GRU_medical_weather.png'
